...
/**
* The controller for headcover reports
 *
 ...
 */
class JC_Headcover_Controller extends JC_AR_Report_Controller {


    public function __construct() {

	    $this->report_type = 'headcover';
        $this->action = 'headcover';
        $this->base_action = 'jc_headcover_report';
        $this->async_request = JC_Registry::get_instance( 'headcover-report' );
...
JC_Registry::set_instance( 'headcover', new JC_Headcover_Controller());
